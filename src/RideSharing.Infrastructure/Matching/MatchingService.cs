...
/// <summary>Ranked matching engine for daily repeat-route commuters.</summary>
public class MatchingService : IMatchingService
{
      ...
      CandidateDriver candidate)
  {
    ...
    if (preference.Preference == GenderPreference.MaleOnly && candidate.User.Gender != Gender.Female)
    {
      result.RejectionReason = "Gender restriction";
      return result;
    }
  ...
  public static double HaversineKm(double lat1, double lon1, double lat2, double lon2)
  {
    ...
    var c = 2 * Math.Atan2(Math.Sqrt(a), 1 - a);
    return R * c;
  }
