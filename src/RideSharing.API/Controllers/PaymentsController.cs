...
public class PaymentsController : ControllerBase
{
  ...
  /// <summary>Confirm JazzCash / EasyPaisa simulated OTP.</summary>
  [HttpPost("{id:guid}/confirm-otp")]
  public async Task<IActionResult> ConfirmOtp(Guid id, [FromBody] ConfirmMobileWalletRequest body)
  {
    var r = await _payments.ConfirmMobileWalletAsync(id, UserId, body);
    return r.Success ? Ok(r) : BadRequest(r);
  }
